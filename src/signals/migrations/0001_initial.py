    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_name', models.ForeignKey(help_text='Signal BaseName', on_delete=django.db.models.deletion.PROTECT, to='signals.signalbasename')),
                ...
                ('signal_type', models.ForeignKey(help_text='Signal Type', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='signals', to='signals.signaltype')),
                ('source', models.ForeignKey(help_text='Source Subdivision', on_delete=django.db.models.deletion.PROTECT, related_name='signals', to='signals.signal')),
            ],
        ),
    ]
